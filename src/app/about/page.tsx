...
export default function About() {
  return (
    <div className="relative isolate min-h-screen px-6 py-24 sm:py-32 lg:px-8 overflow-hidden">
      ...
      <section>
        <div className="mx-auto max-w-3xl text-center relative z-10 mt-20">
          <h1 className="text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">
            About Us
          </h1>
          <p className="mt-8 text-lg text-gray-600 text-left">
        ...
        <div className="mx-auto mt-8 max-w-3xl relative z-10 text-gray-700 text-base leading-relaxed space-y-6">
